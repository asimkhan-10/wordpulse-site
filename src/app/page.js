      ...
      <div className="min-h-screen bg-slate-50 font-sans antialiased text-slate-900 pb-20">
        ...
        <nav className="sticky top-0 z-[100] bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-3 mb-8">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div className="text-lg font-black text-slate-900 tracking-tighter uppercase italic">5 Letter Words</div>
            </div>
          </div>
        </nav>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-slate-100 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="text-[10px] font-bold text-slate-700 hover:text-purple-600 uppercase tracking-widest transition-colors"
                  >
                    Reset
                  </button>
                </div>
            ...
            <section className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-xl min-h-[500px] relative">
                ...
                <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-100">
                  <div className="space-y-1">
                    <div className="text-base font-black text-slate-800 uppercase tracking-wider">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-3">
                      {filteredWords.slice(0, displayLimit).map(word => (
                        <button
                          ...
                          className="group relative h-12 bg-white border-2 border-slate-200 hover:border-purple-500 hover:shadow-md rounded-xl transition-all duration-200 overflow-hidden flex items-center justify-center active:scale-95"
                        >
              ...
              <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  {alphabet.map((char) => (
                    <a key={char} href={`/starting-with/${char}`} className="w-8 h-8 flex items-center justify-center rounded-lg bg-slate-50 border border-slate-100 text-[13px] font-bold text-slate-500 hover:bg-purple-200 hover:border-purple-600 transition-all uppercase cursor-pointer">
                      {char}
                    </a>
                  ))}
                </div>
        ...
        <footer className="py-6 border-t border-slate-200 text-center bg-white mt-12">
          <div className="flex items-center justify-center gap-2 mb-4 opacity-40">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.6em] text-slate-900 italic">5 Letter Words</span>
          </div>
